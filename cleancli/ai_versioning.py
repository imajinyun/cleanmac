...
def _sample_payload_for_schema(schema_name: str) -> dict[str, Any]:
    samples: dict[str, dict[str, Any]] = {
        ...
        "cleanmac.ai-workflow.v1": {
            ...
            "validation": {"schema": "cleanmac.ai-workflow-validation.v1", "valid": True, "violation_count": 0, "violations": []},
        },
        "cleanmac.ai-workflow-validation.v1": {
        ...
        "cleanmac.mcp-destructive-tool-governance.v1": {
            ...
            "destructive_tools": [
                {
                    ...
                    "uses_shell": False,
                    "invocation_mode": "argv",
                    "required_input_fields": ["plan_file", "confirmation_phrase", "confirmation_token", "operation_log"],
                    "safe_argv_template": ["cleanmac", "--json", "clean", "run", "--execute", "--yes", "--operation-log", "/tmp/cleanmac-operations.jsonl"],
                    "mcp_annotations": {
                        "readOnlyHint": False,
            ...
            "checks": [{"id": "destructive-tools-auto-call-denied", "passed": True, "evidence": "cleanmac.mcp-tool-index.v1"}],
            "failed_check_ids": [],
            "validation": {
        ...
        "cleanmac.operation-log-explainability.v1": {
            ...
            "sample_entry": {
                ...
                "parameters": {"command": "cleanmac --json clean run --execute", "category": "downloads", "path": "~/Downloads/example.bin", "delete_mode": "trash"},
                "result": {"action": "delete", "status": "deleted", "deleted": True, "reason": None, "error": None, "trash_path": "~/.Trash/example.bin"},
                "impact_scope": {"category": "downloads", "path": "~/Downloads/example.bin", "bytes": 1024, "human": "1.00 KB", "bundle_id": None, "trash_path": "~/.Trash/example.bin"},
            },
            "checks": [{"id": "operation-log-entry-has-timestamp-tool-parameters-result-impact", "passed": True}],
            "failed_check_ids": [],
            "validation": {"schema": "cleanmac.operation-log-explainability-validation.v1", "valid": True, "violation_count": 0, "violations": []},
        },
        "cleanmac.cold-start-budget.v1": {
            ...
            "failed_check_ids": [],
            "validation": {"schema": "cleanmac.cold-start-budget-validation.v1", "valid": True, "violation_count": 0, "violations": []},
        },
        "cleanmac.dependency-governance.v1": {
            ...
            "pyproject": {
                ...
                "optional_dependency_groups": {"build": ["build>=1.2"], "dev": ["pip-audit>=2.7"], "lint": ["ruff>=0.8"], "test": ["pytest>=8.3"]},
            ...
            "audit": {"safe_for_ci": True, "commands": [["python3", "-m", "pip_audit", "--skip-editable", "--progress-spinner", "off"], ["python3", "scripts/generate_sbom.py", "--output", "SBOM.json"], ["python3", "scripts/security_scan.py"]]},
