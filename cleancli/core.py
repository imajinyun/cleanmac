...
CATEGORIES: tuple[Category, ...] = (
    ...
    Category(
        "spotify",
        APP_CLEANUP_RULES["spotify"]["title"],
        APP_CLEANUP_RULES["spotify"]["paths"],
        "Deletes Spotify regenerable caches while preserving user preferences, local file indexes, and user data.",
        risk="medium",
        advanced=True,
        process_guard="Spotify",
    ),
    Category(
        "telegram",
        APP_CLEANUP_RULES["telegram"]["title"],
        APP_CLEANUP_RULES["telegram"]["paths"],
        "Deletes Telegram regenerable caches while preserving chat history, user data, and configuration.",
        risk="medium",
        advanced=True,
        process_guard="Telegram",
    ),
    Category(
        "wechat",
        APP_CLEANUP_RULES["wechat"]["title"],
        APP_CLEANUP_RULES["wechat"]["paths"],
        "Deletes WeChat regenerable caches while preserving chat messages, contacts, and documents.",
        risk="medium",
        advanced=True,
        process_guard="WeChat",
    ),
    Category(
        "whatsapp",
        APP_CLEANUP_RULES["whatsapp"]["title"],
        APP_CLEANUP_RULES["whatsapp"]["paths"],
        "Deletes WhatsApp regenerable caches while preserving chat storage and documents.",
        risk="medium",
        advanced=True,
        process_guard="WhatsApp",
    ),
    Category(
        "signal",
        APP_CLEANUP_RULES["signal"]["title"],
        APP_CLEANUP_RULES["signal"]["paths"],
        "Deletes Signal regenerable caches while preserving messages, keys, and user configuration.",
        risk="medium",
        advanced=True,
        process_guard="Signal",
    ),
    Category(
        "figma",
        APP_CLEANUP_RULES["figma"]["title"],
        APP_CLEANUP_RULES["figma"]["paths"],
        "Deletes Figma regenerable caches while preserving preferences, local storage, and cookies.",
        risk="medium",
        advanced=True,
        process_guard="Figma",
    ),
    Category(
        "microsoftOffice",
        APP_CLEANUP_RULES["microsoftOffice"]["title"],
        APP_CLEANUP_RULES["microsoftOffice"]["paths"],
        "Deletes Microsoft Office regenerable caches while preserving documents, preferences, and shared group data.",
        risk="medium",
        advanced=True,
    ),
    Category(
        "onenote",
        APP_CLEANUP_RULES["onenote"]["title"],
        APP_CLEANUP_RULES["onenote"]["paths"],
        "Deletes OneNote regenerable caches while preserving notebooks and application data.",
        risk="medium",
        advanced=True,
        process_guard="OneNote",
    ),
    Category(
        "obsidian",
        APP_CLEANUP_RULES["obsidian"]["title"],
        APP_CLEANUP_RULES["obsidian"]["paths"],
        "Deletes Obsidian regenerable caches while preserving vault configuration, preferences, and local storage.",
        risk="medium",
        advanced=True,
        process_guard="Obsidian",
    ),
    Category(
        "sublimeText",
        APP_CLEANUP_RULES["sublimeText"]["title"],
        APP_CLEANUP_RULES["sublimeText"]["paths"],
        "Deletes Sublime Text regenerable caches while preserving user packages, settings, and license data.",
        risk="medium",
        advanced=True,
        process_guard="Sublime Text",
    ),
    Category(
        "opera",
        APP_CLEANUP_RULES["opera"]["title"],
        APP_CLEANUP_RULES["opera"]["paths"],
        "Deletes Opera regenerable browser caches while preserving profile data, cookies, history, passwords, and extensions.",
        risk="medium",
        advanced=True,
        process_guard="Opera",
    ),
    Category(
        "dropbox",
        APP_CLEANUP_RULES["dropbox"]["title"],
        APP_CLEANUP_RULES["dropbox"]["paths"],
        "Deletes Dropbox regenerable caches while preserving synced files, configuration, and authentication data.",
        risk="medium",
        advanced=True,
        process_guard="Dropbox",
    ),
    Category(
        "linear",
        APP_CLEANUP_RULES["linear"]["title"],
        APP_CLEANUP_RULES["linear"]["paths"],
        "Deletes Linear regenerable caches while preserving preferences, local storage, and cookies.",
        risk="medium",
        advanced=True,
        process_guard="Linear",
    ),
    Category(
        "sketch",
        APP_CLEANUP_RULES["sketch"]["title"],
        APP_CLEANUP_RULES["sketch"]["paths"],
        "Deletes Sketch regenerable caches while preserving plugins, libraries, and license data.",
        risk="medium",
        advanced=True,
        process_guard="Sketch",
    ),
    Category(
        "zeplin",
        APP_CLEANUP_RULES["zeplin"]["title"],
        APP_CLEANUP_RULES["zeplin"]["paths"],
        "Deletes Zeplin regenerable caches while preserving preferences, local storage, and cookies.",
        risk="medium",
        advanced=True,
        process_guard="Zeplin",
    ),
    Category(
        "vlc",
        APP_CLEANUP_RULES["vlc"]["title"],
        APP_CLEANUP_RULES["vlc"]["paths"],
        "Deletes VLC regenerable caches while preserving configuration, bookmarks, and playlists.",
        risk="medium",
        advanced=True,
        process_guard="VLC",
    ),
    Category(
        "handbrake",
        APP_CLEANUP_RULES["handbrake"]["title"],
        APP_CLEANUP_RULES["handbrake"]["paths"],
        "Deletes HandBrake regenerable caches while preserving user presets and queue configuration.",
        risk="medium",
        advanced=True,
        process_guard="HandBrake",
    ),
    Category(
        "appleMusic",
        APP_CLEANUP_RULES["appleMusic"]["title"],
        APP_CLEANUP_RULES["appleMusic"]["paths"],
        "Deletes Apple Music regenerable caches while preserving the music library, media files, and playlists.",
        risk="medium",
        advanced=True,
        process_guard="Music",
    ),
    Category(
        "podcasts",
        APP_CLEANUP_RULES["podcasts"]["title"],
        APP_CLEANUP_RULES["podcasts"]["paths"],
        "Deletes Podcasts app regenerable caches while preserving subscriptions and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Podcasts",
    ),
    Category(
        "reddit",
        APP_CLEANUP_RULES["reddit"]["title"],
        APP_CLEANUP_RULES["reddit"]["paths"],
        "Deletes Reddit regenerable caches while preserving preferences, local storage, and cookies.",
        risk="medium",
        advanced=True,
        process_guard="Reddit",
    ),
    Category(
        "googleDrive",
        APP_CLEANUP_RULES["googleDrive"]["title"],
        APP_CLEANUP_RULES["googleDrive"]["paths"],
        "Deletes Google Drive regenerable caches while preserving synced files and account settings.",
        risk="medium",
        advanced=True,
        process_guard="Google Drive",
    ),
    Category(
        "onedrive",
        APP_CLEANUP_RULES["onedrive"]["title"],
        APP_CLEANUP_RULES["onedrive"]["paths"],
        "Deletes OneDrive regenerable caches while preserving synced files and preferences.",
        risk="medium",
        advanced=True,
        process_guard="OneDrive",
    ),
    Category(
        "todoist",
        APP_CLEANUP_RULES["todoist"]["title"],
        APP_CLEANUP_RULES["todoist"]["paths"],
        "Deletes Todoist regenerable caches while preserving tasks, preferences, and local storage.",
        risk="medium",
        advanced=True,
        process_guard="Todoist",
    ),
    Category(
        "things",
        APP_CLEANUP_RULES["things"]["title"],
        APP_CLEANUP_RULES["things"]["paths"],
        "Deletes Things 3 regenerable caches while preserving tasks, documents, and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Things",
    ),
    Category(
        "iterm2",
        APP_CLEANUP_RULES["iterm2"]["title"],
        APP_CLEANUP_RULES["iterm2"]["paths"],
        "Deletes iTerm2 regenerable caches while preserving profiles, scripts, and preferences.",
        risk="medium",
        advanced=True,
        process_guard="iTerm",
    ),
    Category(
        "qq",
        APP_CLEANUP_RULES["qq"]["title"],
        APP_CLEANUP_RULES["qq"]["paths"],
        "Deletes QQ regenerable caches while preserving chat messages, contacts, and documents.",
        risk="medium",
        advanced=True,
        process_guard="QQ",
    ),
    Category(
        "dingTalk",
        APP_CLEANUP_RULES["dingTalk"]["title"],
        APP_CLEANUP_RULES["dingTalk"]["paths"],
        "Deletes DingTalk regenerable caches while preserving user data, messages, and preferences.",
        risk="medium",
        advanced=True,
        process_guard="DingTalk",
    ),
    Category(
        "feishu",
        APP_CLEANUP_RULES["feishu"]["title"],
        APP_CLEANUP_RULES["feishu"]["paths"],
        "Deletes Feishu regenerable caches while preserving messages, user data, and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Lark",
    ),
    Category(
        "evernote",
        APP_CLEANUP_RULES["evernote"]["title"],
        APP_CLEANUP_RULES["evernote"]["paths"],
        "Deletes Evernote regenerable caches while preserving notes, notebooks, and account data.",
        risk="medium",
        advanced=True,
        process_guard="Evernote",
    ),
    Category(
        "youdaoNote",
        APP_CLEANUP_RULES["youdaoNote"]["title"],
        APP_CLEANUP_RULES["youdaoNote"]["paths"],
        "Deletes Youdao Note regenerable caches while preserving notes and preferences.",
        risk="medium",
        advanced=True,
        process_guard="YoudaoNote",
    ),
    Category(
        "warp",
        APP_CLEANUP_RULES["warp"]["title"],
        APP_CLEANUP_RULES["warp"]["paths"],
        "Deletes Warp regenerable caches while preserving settings, local storage, and configuration.",
        risk="medium",
        advanced=True,
        process_guard="Warp",
    ),
    Category(
        "tablePlus",
        APP_CLEANUP_RULES["tablePlus"]["title"],
        APP_CLEANUP_RULES["tablePlus"]["paths"],
        "Deletes TablePlus regenerable caches while preserving connections and license data.",
        risk="medium",
        advanced=True,
        process_guard="TablePlus",
    ),
    Category(
        "torBrowser",
        APP_CLEANUP_RULES["torBrowser"]["title"],
        APP_CLEANUP_RULES["torBrowser"]["paths"],
        "Deletes Tor Browser regenerable caches while preserving bookmarks, passwords, and extensions.",
        risk="medium",
        advanced=True,
        process_guard="TorBrowser",
    ),
    Category(
        "mega",
        APP_CLEANUP_RULES["mega"]["title"],
        APP_CLEANUP_RULES["mega"]["paths"],
        "Deletes MEGA regenerable caches while preserving synced files and configuration.",
        risk="medium",
        advanced=True,
        process_guard="MEGA",
    ),
    Category(
        "sync",
        APP_CLEANUP_RULES["sync"]["title"],
        APP_CLEANUP_RULES["sync"]["paths"],
        "Deletes Sync.com regenerable caches while preserving synced files and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Sync",
    ),
    Category(
        "webex",
        APP_CLEANUP_RULES["webex"]["title"],
        APP_CLEANUP_RULES["webex"]["paths"],
        "Deletes Webex regenerable caches while preserving recordings, preferences, and meeting data.",
        risk="medium",
        advanced=True,
        process_guard="Webex",
    ),
    Category(
        "blender",
        APP_CLEANUP_RULES["blender"]["title"],
        APP_CLEANUP_RULES["blender"]["paths"],
        "Deletes Blender regenerable caches while preserving configs, scripts, and project files.",
        risk="medium",
        advanced=True,
        process_guard="Blender",
    ),
    Category(
        "affinity",
        APP_CLEANUP_RULES["affinity"]["title"],
        APP_CLEANUP_RULES["affinity"]["paths"],
        "Deletes Affinity Photo, Designer, and Publisher regenerable caches while preserving documents.",
        risk="medium",
        advanced=True,
        process_guard="Affinity",
    ),
    Category(
        "alfred",
        APP_CLEANUP_RULES["alfred"]["title"],
        APP_CLEANUP_RULES["alfred"]["paths"],
        "Deletes Alfred regenerable caches while preserving workflows, preferences, and settings.",
        risk="medium",
        advanced=True,
        process_guard="Alfred",
    ),
    Category(
        "notionCalendar",
        APP_CLEANUP_RULES["notionCalendar"]["title"],
        APP_CLEANUP_RULES["notionCalendar"]["paths"],
        "Deletes Notion Calendar regenerable caches while preserving events, preferences, and local storage.",
        risk="medium",
        advanced=True,
        process_guard="Notion Calendar",
    ),
    Category(
        "hopper",
        APP_CLEANUP_RULES["hopper"]["title"],
        APP_CLEANUP_RULES["hopper"]["paths"],
        "Deletes Hopper Disassembler regenerable caches while preserving licenses and project files.",
        risk="medium",
        advanced=True,
        process_guard="Hopper",
    ),
    Category(
        "charles",
        APP_CLEANUP_RULES["charles"]["title"],
        APP_CLEANUP_RULES["charles"]["paths"],
        "Deletes Charles Proxy regenerable caches while preserving certificates, config, and licenses.",
        risk="medium",
        advanced=True,
        process_guard="Charles",
    ),
    Category(
        "proxyman",
        APP_CLEANUP_RULES["proxyman"]["title"],
        APP_CLEANUP_RULES["proxyman"]["paths"],
        "Deletes Proxyman regenerable caches while preserving documents, preferences, and licenses.",
        risk="medium",
        advanced=True,
        process_guard="Proxyman",
    ),
    Category(
        "parallels",
        APP_CLEANUP_RULES["parallels"]["title"],
        APP_CLEANUP_RULES["parallels"]["paths"],
        "Deletes Parallels Desktop regenerable caches while preserving virtual machines and licenses.",
        risk="high",
        advanced=True,
        process_guard="Parallels",
    ),
    Category(
        "vmwareFusion",
        APP_CLEANUP_RULES["vmwareFusion"]["title"],
        APP_CLEANUP_RULES["vmwareFusion"]["paths"],
        "Deletes VMware Fusion regenerable caches while preserving virtual machines and licenses.",
        risk="high",
        advanced=True,
        process_guard="VMware Fusion",
    ),
    Category(
        "canva",
        APP_CLEANUP_RULES["canva"]["title"],
        APP_CLEANUP_RULES["canva"]["paths"],
        "Deletes Canva regenerable caches while preserving local storage, preferences, and cookies.",
        risk="medium",
        advanced=True,
        process_guard="Canva",
    ),
    Category(
        "principle",
        APP_CLEANUP_RULES["principle"]["title"],
        APP_CLEANUP_RULES["principle"]["paths"],
        "Deletes Principle regenerable caches while preserving licenses and project files.",
        risk="medium",
        advanced=True,
        process_guard="Principle",
    ),
    Category(
        "framer",
        APP_CLEANUP_RULES["framer"]["title"],
        APP_CLEANUP_RULES["framer"]["paths"],
        "Deletes Framer regenerable caches while preserving projects, local storage, and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Framer",
    ),
    Category(
        "imovie",
        APP_CLEANUP_RULES["imovie"]["title"],
        APP_CLEANUP_RULES["imovie"]["paths"],
        "Deletes iMovie regenerable render caches while preserving libraries and video projects.",
        risk="medium",
        advanced=True,
        process_guard="iMovie",
    ),
    Category(
        "finalCutPro",
        APP_CLEANUP_RULES["finalCutPro"]["title"],
        APP_CLEANUP_RULES["finalCutPro"]["paths"],
        "Deletes Final Cut Pro regenerable caches while preserving libraries and project files.",
        risk="high",
        advanced=True,
        process_guard="Final Cut Pro",
    ),
    Category(
        "logicPro",
        APP_CLEANUP_RULES["logicPro"]["title"],
        APP_CLEANUP_RULES["logicPro"]["paths"],
        "Deletes Logic Pro regenerable caches while preserving projects, instruments, and plugins.",
        risk="high",
        advanced=True,
        process_guard="Logic Pro",
    ),
    Category(
        "bear",
        APP_CLEANUP_RULES["bear"]["title"],
        APP_CLEANUP_RULES["bear"]["paths"],
        "Deletes Bear regenerable caches while preserving notes and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Bear",
    ),
    Category(
        "ulysses",
        APP_CLEANUP_RULES["ulysses"]["title"],
        APP_CLEANUP_RULES["ulysses"]["paths"],
        "Deletes Ulysses regenerable caches while preserving documents and writing data.",
        risk="medium",
        advanced=True,
        process_guard="Ulysses",
    ),
    Category(
        "fantastical",
        APP_CLEANUP_RULES["fantastical"]["title"],
        APP_CLEANUP_RULES["fantastical"]["paths"],
        "Deletes Fantastical regenerable caches while preserving calendar preferences and data.",
        risk="medium",
        advanced=True,
        process_guard="Fantastical",
    ),
    Category(
        "rectangle",
        APP_CLEANUP_RULES["rectangle"]["title"],
        APP_CLEANUP_RULES["rectangle"]["paths"],
        "Deletes Rectangle regenerable caches while preserving preferences and shortcuts.",
        risk="low",
        advanced=True,
        process_guard="Rectangle",
    ),
    Category(
        "onePassword",
        APP_CLEANUP_RULES["onePassword"]["title"],
        APP_CLEANUP_RULES["onePassword"]["paths"],
        "Deletes 1Password regenerable caches while preserving vaults, credentials, and group container data.",
        risk="high",
        advanced=True,
        process_guard="1Password",
    ),
    Category(
        "bitwarden",
        APP_CLEANUP_RULES["bitwarden"]["title"],
        APP_CLEANUP_RULES["bitwarden"]["paths"],
        "Deletes Bitwarden regenerable caches while preserving vault data and credentials.",
        risk="high",
        advanced=True,
        process_guard="Bitwarden",
    ),
    Category(
        "dashlane",
        APP_CLEANUP_RULES["dashlane"]["title"],
        APP_CLEANUP_RULES["dashlane"]["paths"],
        "Deletes Dashlane regenerable caches while preserving vault data and local storage.",
        risk="high",
        advanced=True,
        process_guard="Dashlane",
    ),
    Category(
        "sequelAce",
        APP_CLEANUP_RULES["sequelAce"]["title"],
        APP_CLEANUP_RULES["sequelAce"]["paths"],
        "Deletes Sequel Ace regenerable caches while preserving documents, favorites, and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Sequel Ace",
    ),
    Category(
        "orbStack",
        APP_CLEANUP_RULES["orbStack"]["title"],
        APP_CLEANUP_RULES["orbStack"]["paths"],
        "Deletes OrbStack regenerable caches while preserving machines, containers, and SSH keys.",
        risk="high",
        advanced=True,
        process_guard="OrbStack",
    ),
    Category(
        "transmit",
        APP_CLEANUP_RULES["transmit"]["title"],
        APP_CLEANUP_RULES["transmit"]["paths"],
        "Deletes Transmit regenerable caches while preserving favorites, documents, and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Transmit",
    ),
    Category(
        "nordVPN",
        APP_CLEANUP_RULES["nordVPN"]["title"],
        APP_CLEANUP_RULES["nordVPN"]["paths"],
        "Deletes NordVPN regenerable caches while preserving preferences and configuration.",
        risk="medium",
        advanced=True,
        process_guard="NordVPN",
    ),
    Category(
        "surfshark",
        APP_CLEANUP_RULES["surfshark"]["title"],
        APP_CLEANUP_RULES["surfshark"]["paths"],
        "Deletes Surfshark regenerable caches while preserving preferences and configuration.",
        risk="medium",
        advanced=True,
        process_guard="Surfshark",
    ),
    Category(
        "grammarly",
        APP_CLEANUP_RULES["grammarly"]["title"],
        APP_CLEANUP_RULES["grammarly"]["paths"],
        "Deletes Grammarly regenerable caches while preserving preferences and user data.",
        risk="medium",
        advanced=True,
        process_guard="Grammarly",
    ),
    Category(
        "mimestream",
        APP_CLEANUP_RULES["mimestream"]["title"],
        APP_CLEANUP_RULES["mimestream"]["paths"],
        "Deletes Mimestream regenerable caches while preserving mail data and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Mimestream",
    ),
    Category(
        "reeder",
        APP_CLEANUP_RULES["reeder"]["title"],
        APP_CLEANUP_RULES["reeder"]["paths"],
        "Deletes Reeder regenerable caches while preserving feeds and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Reeder",
    ),
    Category(
        "kindle",
        APP_CLEANUP_RULES["kindle"]["title"],
        APP_CLEANUP_RULES["kindle"]["paths"],
        "Deletes Kindle regenerable caches while preserving e-books and library content.",
        risk="medium",
        advanced=True,
        process_guard="Kindle",
    ),
    Category(
        "cleanShot",
        APP_CLEANUP_RULES["cleanShot"]["title"],
        APP_CLEANUP_RULES["cleanShot"]["paths"],
        "Deletes CleanShot X regenerable caches while preserving screenshots and preferences.",
        risk="medium",
        advanced=True,
        process_guard="CleanShot X",
    ),
    Category(
        "snagit",
        APP_CLEANUP_RULES["snagit"]["title"],
        APP_CLEANUP_RULES["snagit"]["paths"],
        "Deletes Snagit regenerable caches while preserving captures and preferences.",
        risk="medium",
        advanced=True,
    ...
    Category(
        "notionEnhancer",
        APP_CLEANUP_RULES["notionEnhancer"]["title"],
        APP_CLEANUP_RULES["notionEnhancer"]["paths"],
        "Deletes Notion Enhancer regenerable caches.",
        risk="medium",
        advanced=True,
        process_guard="Notion",
    ),
    Category(
        "logiOptions",
        APP_CLEANUP_RULES["logiOptions"]["title"],
        APP_CLEANUP_RULES["logiOptions"]["paths"],
        "Deletes Logi Options+ regenerable caches while preserving device settings and profiles.",
        risk="medium",
        advanced=True,
        process_guard="Logi Options+",
    ),
    Category(
        "elgatoControl",
        APP_CLEANUP_RULES["elgatoControl"]["title"],
        APP_CLEANUP_RULES["elgatoControl"]["paths"],
        "Deletes Elgato Control Center regenerable caches.",
        risk="medium",
        advanced=True,
        process_guard="Elgato Control Center",
    ),
    Category(
        "microsoftRemoteDesktop",
        APP_CLEANUP_RULES["microsoftRemoteDesktop"]["title"],
        APP_CLEANUP_RULES["microsoftRemoteDesktop"]["paths"],
        "Deletes Microsoft Remote Desktop regenerable caches while preserving saved connections and credentials.",
        risk="medium",
        advanced=True,
        process_guard="Microsoft Remote Desktop",
    ),
    Category(
        "cyberduck",
        APP_CLEANUP_RULES["cyberduck"]["title"],
        APP_CLEANUP_RULES["cyberduck"]["paths"],
        "Deletes Cyberduck regenerable caches while preserving bookmarks and connection profiles.",
        risk="medium",
        advanced=True,
        process_guard="Cyberduck",
    ),
    Category(
        "alDente",
        APP_CLEANUP_RULES["alDente"]["title"],
        APP_CLEANUP_RULES["alDente"]["paths"],
        "Deletes AlDente battery manager regenerable caches.",
        risk="medium",
        advanced=True,
        process_guard="AlDente",
    ),
    Category(
        "iStatMenus",
        APP_CLEANUP_RULES["iStatMenus"]["title"],
        APP_CLEANUP_RULES["iStatMenus"]["paths"],
        "Deletes iStat Menus regenerable caches while preserving sensor configuration and preferences.",
        risk="medium",
        advanced=True,
        process_guard="iStat Menus",
    ),
    Category(
        "bartender",
        APP_CLEANUP_RULES["bartender"]["title"],
        APP_CLEANUP_RULES["bartender"]["paths"],
        "Deletes Bartender menu bar regenerable caches.",
        risk="medium",
        advanced=True,
        process_guard="Bartender",
    ),
    Category(
        "hazel",
        APP_CLEANUP_RULES["hazel"]["title"],
        APP_CLEANUP_RULES["hazel"]["paths"],
        "Deletes Hazel file automation regenerable caches while preserving rules and preferences.",
        risk="medium",
        advanced=True,
        process_guard="Hazel",
    ),
    Category(
        "betterTouchTool",
        APP_CLEANUP_RULES["betterTouchTool"]["title"],
        APP_CLEANUP_RULES["betterTouchTool"]["paths"],
        "Deletes BetterTouchTool regenerable caches while preserving gestures, triggers, and license data.",
        risk="medium",
        advanced=True,
        process_guard="BetterTouchTool",
    ),
    Category(
        "karabiner",
        APP_CLEANUP_RULES["karabiner"]["title"],
        APP_CLEANUP_RULES["karabiner"]["paths"],
        "Deletes Karabiner-Elements regenerable caches while preserving keyboard configuration and complex modifications.",
        risk="medium",
        advanced=True,
        process_guard="Karabiner-Elements",
    ),
    Category(
        "quicksilver",
        APP_CLEANUP_RULES["quicksilver"]["title"],
        APP_CLEANUP_RULES["quicksilver"]["paths"],
        "Deletes Quicksilver launcher regenerable caches while preserving plugins and triggers.",
        risk="medium",
        advanced=True,
        process_guard="Quicksilver",
    ),
    Category(
        "microsoftOutlook",
        APP_CLEANUP_RULES["microsoftOutlook"]["title"],
        APP_CLEANUP_RULES["microsoftOutlook"]["paths"],
        "Deletes Microsoft Outlook regenerable caches while preserving mailboxes, identities, and accounts.",
        risk="high",
        advanced=True,
        process_guard="Outlook",
    ),
    Category(
        "soundSource",
        APP_CLEANUP_RULES["soundSource"]["title"],
        APP_CLEANUP_RULES["soundSource"]["paths"],
        "Deletes SoundSource regenerable caches.",
        risk="medium",
        advanced=True,
        process_guard="SoundSource",
    ),
    Category(
        "audioHijack",
        APP_CLEANUP_RULES["audioHijack"]["title"],
        APP_CLEANUP_RULES["audioHijack"]["paths"],
        "Deletes Audio Hijack regenerable caches while preserving session files and recordings.",
        risk="medium",
        advanced=True,
        process_guard="Audio Hijack",
    ),
    Category(
        "displayLink",
        APP_CLEANUP_RULES["displayLink"]["title"],
        APP_CLEANUP_RULES["displayLink"]["paths"],
        "Deletes DisplayLink Manager regenerable caches.",
        risk="medium",
        advanced=True,
        process_guard="DisplayLink Manager",
    ),
    Category(
        "corsairIcue",
        APP_CLEANUP_RULES["corsairIcue"]["title"],
        APP_CLEANUP_RULES["corsairIcue"]["paths"],
        "Deletes Corsair iCUE regenerable caches while preserving device profiles and macros.",
        risk="medium",
        advanced=True,
        process_guard="iCUE",
    ),
    Category(
        "razerSynapse",
        APP_CLEANUP_RULES["razerSynapse"]["title"],
        APP_CLEANUP_RULES["razerSynapse"]["paths"],
        "Deletes Razer Synapse regenerable caches while preserving device profiles and macros.",
        risk="medium",
        advanced=True,
        process_guard="Razer Synapse",
    ),
    Category(
        "folx",
        APP_CLEANUP_RULES["folx"]["title"],
        APP_CLEANUP_RULES["folx"]["paths"],
        "Deletes Folx download manager regenerable caches while preserving downloads and tags.",
        risk="medium",
        advanced=True,
        process_guard="Folx",
    ),
...
def render_ai_workflow(categories: list[Category], *, goal: str, root: Path, home: Path) -> dict[str, Any]:
    ...
    steps = [
        ...
        _ai_workflow_step(
            ...
            destructive=False,
            auto_call_allowed=True,
            next_human_action="📝 Review the generated plan summary before creating a selection.",
        ...
        _ai_workflow_step(
            ...
            destructive=False,
            auto_call_allowed=True,
            next_human_action="🛡️ No action unless validation reports stale context or an unsupported schema.",
        ...
        _ai_workflow_step(
            ...
            destructive=False,
            auto_call_allowed=True,
            next_human_action="🚦 Resolve every blocking_reasons entry before preparing execution.",
    ...
    payload = {
        ...
        "workflow_summary": "🔒 This is a zero-resident, dry-run-first workflow. AI Hosts may prepare plans and evidence, but destructive execution is gated by human confirmation, a matching dry-run token, Trash routing, plan-context validation, and an operation log.",
        "runtime_lifecycle": {
