...
class AIHostIntegrationPackTests(unittest.TestCase):
    def test_pack_aggregates_one_stop_host_discovery_metadata(self) -> None:
        ...
        self.assertTrue(pack["cold_start_budget"]["ready"], pack["cold_start_budget"])
        self.assertEqual(pack["cold_start_budget"]["budgets"]["resident_processes_after_exit"], 0)
        self.assertEqual(pack["no_disturbance"]["schema"], "cleanmac.no-disturbance.v1")
        self.assertTrue(pack["no_disturbance"]["ready"], pack["no_disturbance"])
        self.assertTrue(pack["no_disturbance"]["silent_by_default"])
        self.assertFalse(pack["no_disturbance"]["sends_notifications"])
        ...
        self.assertIn("cleanmac://mcp/destructive-tool-governance", pack["mcp"]["resources"])
        self.assertIn("cleanmac://ai/operation-log-explainability", pack["mcp"]["resources"])
        self.assertIn("cleanmac://ai/cold-start-budget", pack["mcp"]["resources"])
        self.assertIn("cleanmac://ai/no-disturbance", pack["mcp"]["resources"])
        self.assertIn("cleanmac://release/dependency-governance", pack["mcp"]["resources"])
        ...
        self.assertEqual(
            pack["mcp"]["destructive_tool_governance_uri"], "cleanmac://mcp/destructive-tool-governance"
        )
        self.assertEqual(
            pack["mcp"]["operation_log_explainability_uri"], "cleanmac://ai/operation-log-explainability"
        )
        self.assertEqual(pack["mcp"]["cold_start_budget_uri"], "cleanmac://ai/cold-start-budget")
        self.assertEqual(pack["mcp"]["no_disturbance_uri"], "cleanmac://ai/no-disturbance")
        ...
        self.assertEqual(pack["recommended_call_sequence"][4], "read cleanmac://mcp/destructive-tool-governance")
        self.assertEqual(pack["recommended_call_sequence"][5], "read cleanmac://ai/operation-log-explainability")
        self.assertEqual(pack["recommended_call_sequence"][6], "read cleanmac://ai/cold-start-budget")
        self.assertEqual(pack["recommended_call_sequence"][7], "read cleanmac://ai/no-disturbance")
        self.assertEqual(pack["recommended_call_sequence"][8], "read cleanmac://release/dependency-governance")
        self.assertEqual(pack["recommended_call_sequence"][9], "read cleanmac://mcp/surface-audit")
        self.assertEqual(pack["recommended_call_sequence"][10], "read cleanmac://ai/host-integration-pack")
        self.assertEqual(pack["recommended_call_sequence"][11], "read cleanmac://ai/entrypoints")
        self.assertEqual(pack["recommended_call_sequence"][12], "read cleanmac://ai/safety-chain")
        self.assertEqual(pack["recommended_call_sequence"][13], "read cleanmac://ai/workflow-contract")
        ...
        self.assertIn("read cleanmac://mcp/destructive-tool-governance", pack["recommended_call_sequence"])
        self.assertIn("read cleanmac://ai/operation-log-explainability", pack["recommended_call_sequence"])
        self.assertIn("read cleanmac://ai/cold-start-budget", pack["recommended_call_sequence"])
        self.assertIn("read cleanmac://ai/no-disturbance", pack["recommended_call_sequence"])
        self.assertIn("read cleanmac://release/dependency-governance", pack["recommended_call_sequence"])
    ...
    def test_evidence_reports_runtime_governance_audit_pack(self) -> None:
        ...
        self.assertEqual(evidence["no_disturbance"]["schema"], "cleanmac.no-disturbance.v1")
        self.assertTrue(evidence["no_disturbance"]["ready"], evidence["no_disturbance"])
    ...
    def test_preflight_reports_runtime_governance_gate(self) -> None:
        ...
        self.assertEqual(
            preflight["entrypoint"]["mcp_destructive_tool_governance"],
            "cleanmac://mcp/destructive-tool-governance",
        )
        self.assertEqual(
            preflight["entrypoint"]["operation_log_explainability"],
            "cleanmac://ai/operation-log-explainability",
        )
        self.assertEqual(preflight["entrypoint"]["cold_start_budget"], "cleanmac://ai/cold-start-budget")
        self.assertEqual(preflight["entrypoint"]["no_disturbance"], "cleanmac://ai/no-disturbance")
        self.assertEqual(preflight["entrypoint"]["dependency_governance"], "cleanmac://release/dependency-governance")
        ...
        self.assertTrue(checks["no-disturbance-ready"]["passed"])
        self.assertTrue(checks["dependency-governance-ready"]["passed"])
        ...
        self.assertEqual(checks["no-disturbance-ready"]["evidence"], "cleanmac://ai/no-disturbance")
        self.assertEqual(checks["dependency-governance-ready"]["evidence"], "cleanmac://release/dependency-governance")
