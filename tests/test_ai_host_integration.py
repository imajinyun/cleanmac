...
class AIHostIntegrationPackTests(unittest.TestCase):
    def test_pack_aggregates_one_stop_host_discovery_metadata(self) -> None:
        ...
        self.assertEqual(pack["recommended_call_sequence"][7], "read cleanmac://release/dependency-governance")
        self.assertEqual(pack["recommended_call_sequence"][8], "read cleanmac://mcp/surface-audit")
        self.assertEqual(pack["recommended_call_sequence"][9], "read cleanmac://ai/host-integration-pack")
        self.assertEqual(pack["recommended_call_sequence"][10], "read cleanmac://ai/entrypoints")
        self.assertEqual(pack["recommended_call_sequence"][11], "read cleanmac://ai/safety-chain")
        self.assertEqual(pack["recommended_call_sequence"][12], "read cleanmac://ai/workflow-contract")
