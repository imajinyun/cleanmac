...
- [ ] Add pytest coverage for inspect direct child size sorting, limit behavior, and AI summary metadata.
- [ ] Validate with targeted pytest, ruff format/check, and `make pytest-test`.
- [ ] Commit with `test(pytest): cover inspect direct child sorting`.
...
- [ ] Add pytest coverage for inspect budget flags as non-destructive preview metadata.
- [ ] Validate with targeted pytest, ruff format/check, and `make pytest-test`.
- [ ] Commit with `test(pytest): cover inspect budget preview flags`.
...
- [ ] Add pytest coverage for Mail Downloads age and minimum-size defaults.
- [ ] Validate with targeted pytest, ruff format/check, and `make pytest-test`.
- [ ] Commit with `test(pytest): cover mail downloads age size defaults`.
